    ...
    <div className="flex min-h-screen flex-col bg-black text-white">
      <header className="container mx-auto flex h-16 items-center justify-between px-4">
        <div className="flex items-center">
          <h1 className="text-xl font-bold text-white">Cappsy</h1>
        </div>
        <div className="flex items-center space-x-4">
          <Button variant="ghost" className="text-white hover:bg-gray-800" onClick={() => router.push("/login")}>
            Iniciar sesion
          </Button>
          <Button className="bg-red-600 text-white hover:bg-red-700" onClick={() => router.push("/register")}>
            Registrarse
          </Button>
        </div>
      </header>
      ...
      <main className="container mx-auto flex-1 px-4 py-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:gap-16">
          ...
          <div className="flex items-center justify-center">
            <Card className="w-full max-w-md overflow-hidden rounded-xl border-0 bg-gray-900">
        ...
        <div className="mt-24 grid grid-cols-1 gap-8 md:grid-cols-3">
          <Card className="border-0 bg-gray-900">
            <CardContent className="p-6">
              <div className="mb-4 rounded-full bg-red-600/20 p-3 w-12 h-12 flex items-center justify-center">
                <svg
